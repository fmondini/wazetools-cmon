...
%>
<%!
	final String TMP_TABLE = "CMON_tmpStats_REG";
%>
	<div class="DS-text-black DS-back-gray DS-border-dn DS-padding-3px" align="center">TOP 20 Regions</div>
...
<%
	...
	try {
		...
		while (rs.next()) {
			...
			stUpd.executeUpdate("UPDATE " + this.TMP_TABLE + " SET Percent = " + newPercent + " WHERE GeoRef = '" + RegName + "'");
		}
		...
		while (rs.next()) {
%>
			<tr class="" style="<%= "" /* Region.equals(defaultRegion) ? HILITE_TD : "" */ %>">
